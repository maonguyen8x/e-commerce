...
const Basket = () => {
  ...
  return user && user.role === 'ADMIN' ? null : (
    <Boundary>
      ...
      >
        <p className="text-center">{t('you_must_sign_in_to_continue_checking_out')}</p>
        <br />
      ...
      <div className="basket">
        <div className="basket-list">
          ...
          {basket.length <= 0 && (
            <div className="basket-empty">
              <h5 className="basket-empty-msg">{t('your_basket_is_empty')}</h5>
            </div>
          )}
        ...
        <div className="basket-checkout">
          <div className="basket-total">
            <p className="basket-total-title">{t('subtotal_amout')}:</p>
