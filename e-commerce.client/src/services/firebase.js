...
class Firebase {
  ...
  signInWithGoogle = async() =>
    await this.auth.signInWithPopup(new app.auth.GoogleAuthProvider());

  signInWithFacebook = async() =>
    await this.auth.signInWithPopup(new app.auth.FacebookAuthProvider());

  signInWithGithub = async() =>
    await this.auth.signInWithPopup(new app.auth.GithubAuthProvider());

  signOut = async() => await this.auth.signOut();

  passwordReset = async(email) => await this.auth.sendPasswordResetEmail(email);

  addUser = async(id, user) => await this.db.collection("users").doc(id).set(user);

  getUser = async(id) => await this.db.collection("users").doc(id).get();
  ...
  deleteUserImage = (id) => this.storage.ref("users").child(id).delete();

  // Get all users
  getAllUsers = async(lastRefKey) => {
  ...
  passwordUpdate = async(password) => await this.auth.currentUser.updatePassword(password);
  ...
  getSingleProduct = async(id) => await this.db.collection("products").doc(id).get();
